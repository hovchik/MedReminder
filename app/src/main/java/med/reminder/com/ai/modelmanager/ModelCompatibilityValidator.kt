...
import med.reminder.com.ai.local.RuntimeType
...
class ModelCompatibilityValidator @Inject constructor(
    ...
    fun validate(model: LocalAiModel): ValidationResult {
        ...
        val deviceRamMb = when (caps.ramTier) {
            med.reminder.com.ai.capability.RamTier.LOW -> 3072L
            med.reminder.com.ai.capability.RamTier.MEDIUM -> 5120L
            med.reminder.com.ai.capability.RamTier.HIGH -> 7168L
            med.reminder.com.ai.capability.RamTier.VERY_HIGH -> 10240L
        }
